...
<main class="contenido">
    ...
    <div class="extra-buttons">
        <a href="inico_Admin.php"><button type="button" onclick="window.location.href='index.php'">Volver</button></a>
        <a href="ver_tapro.php"><button type="button" onclick="window.location.href='ver_tareas_asignadas.php'">Ver tareas asignadas</button></a>
    </div>
</main>
<script>
